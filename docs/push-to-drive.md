...
Two destinations, both reached from menu **section 1** (Lyrics, items
**1·8–1·14**) and both driven by
...
## 1·9 — copy next to the mp3 (local, for sync testing)
...
## 1·10 / 1·11 — push to Google Drive (rclone)
...
## 1·12 / 1·13 / 1·14 — push a past commit's lyrics to Drive
